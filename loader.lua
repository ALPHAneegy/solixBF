...
function to(p241)
    pcall(function()
        if (p241.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 2000 and (not Auto_Raid and 0 < game.Players.LocalPlayer.Character.Humanoid.Health) then
                            ...
                            if NameMon ~= 'ShipQuest2' then
                                if NameMon ~= 'FrostQuest' then
                                    repeat
                                        ...
                                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p241
                                    until (p241.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2500 and 0 < game.Players.LocalPlayer.Character.Humanoid.Health
...
_ImageButton.Image = 'http://www.roblox.com/asset/?id=98977023494737'
...
u3.Info:AddParagraph({
    Title = 'Developer V.Roy',
    Content = 'Skill: High level',
})
...
u3.Info:AddParagraph({
    Title = 'Update',
    Content = 'I will update more features in the future',
})
u3.Info:AddParagraph({
    Title = 'Supported Android and iOS Clients',
    Content = 'All Android and Ios Clients',
})
u3.Info:AddParagraph({
                ...
                if string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) and game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible ~= false then
                    if string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) or game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                        ...
                        while true do
                            ...
                            if v271:FindFirstChild('Humanoid') and v271:FindFirstChild('HumanoidRootPart') and (v271.Humanoid.Health > 0 and v271.Name == Ms) then
                                repeat
                                    ...
                                    MonFarm = v271.Name
                                until not (_G.AutoLevel and v271.Parent) or v271.Humanoid.Health <= 0 or (not game:GetService('Workspace').Enemies:FindFirstChild(v271.Name) or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false)
                        ...
                        while true do
                            ...
                            if string.find(v275.Name, NameMon) and 10 <= (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v275.Position).Magnitude then
                ...
                while true do
                    ...
                    if v280:FindFirstChild('Humanoid') and v280:FindFirstChild('HumanoidRootPart') and (v280.Humanoid.Health > 0 and v280.Name) and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v280:FindFirstChild('HumanoidRootPart').Position).Magnitude <= 5000 then
                        repeat
                            ...
                            MonFarm = v280.Name
                        until not (_G.AutoNear and v280.Parent) or v280.Humanoid.Health <= 0 or not game.Workspace.Enemies:FindFirstChild(v280.Name)
            ...
            pcall(function()
                ...
                if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 500 then
                    ...
                    while true do
                        ...
                        if _G.CastleRaid and v286:FindFirstChild('HumanoidRootPart') and (v286:FindFirstChild('Humanoid') and 0 < v286.Humanoid.Health) and (v286.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2000 then
                            repeat
                                wait(_G.Fast_Delay)
                                AttackNoCoolDown()
                                AutoHaki()
                            ...
                            until v286.Humanoid.Health <= 0 or not v286.Parent or not _G.CastleRaid
                        end
                    end
                end
            end)
...
u3.Main:AddToggle('ToggleHakiFortress', {
    Title = 'Turn on Haki Color Castle',
    Description = '',
    Default = false,
    ...
    while wait() do
        if _G.AutoCollectBerry then
            ...
            if v312 then
                ...
                u1:Notify({
                    Title = 'Strix',
                    Content = 'Find Berry: ' .. tostring(v313),
                    Duration = 10,
                })
            else
                Hop()
    ...
    while task.wait() do
        if _G.UseSkill then
            pcall(function()
                ...
                PositionSkillMasteryDevilFruit = v334.HumanoidRootPart.Position
                ...
                if AutoFarmMasDevilFruit and _G.UseSkill and v334.Humanoid.Health ~= 0 then
                end

                local v334

                v332, v334 = v330(v331, v332)

                if v332 == nil then
                end
                if v334.Name ~= MonFarm or not v334:FindFirstChild('Humanoid') or (not v334:FindFirstChild('HumanoidRootPart') or v334.Humanoid.Health > v334.Humanoid.MaxHealth * KillPercent / 100) then
                else
                end
            end)
        end
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                u426:SetDesc('You have: ' .. tostring(_Bones) .. ' Bone')
            end
        end)
    end)
                                ...
                                if v434:FindFirstChild('HumanoidRootPart') and v434:FindFirstChild('Humanoid') and v434.Humanoid.Health > 0 and (v434.Name == 'Reborn Skeleton' or v434.Name == 'Living Zombie' or (v434.Name == 'Demonic Soul' or v434.Name == 'Posessed Mummy')) then
                                    if string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Demonic Soul') then
                                        repeat
                                            ...
                                            MonFarm = v434.Name
                                        until not _G.AutoBone or v434.Humanoid.Health <= 0 or not v434.Parent or game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                    else
                                        game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('AbandonQuest')
...
if Sea3 then
    u3.Main:AddSection('Cake Prince')
                ...
                if string.len(game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('CakePrinceSpawner')) ~= 88 then
                    if string.len(game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('CakePrinceSpawner')) ~= 87 then
                        if string.len(game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('CakePrinceSpawner')) ~= 86 then
                            u441:SetDesc('Cake Prince : \u{2705}\u{fe0f}')
                        else
                    ...
                    u441:SetDesc('Remaining:' .. string.sub(game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('CakePrinceSpawner'), 39, 41) .. '')
                end
            end)
        end
    end)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild(_G.SelectBoss) then
                    ...
                    while true do
                        ...
                        if v475.Name == _G.SelectBoss and v475:FindFirstChild('Humanoid') and (v475:FindFirstChild('HumanoidRootPart') and 0 < v475.Humanoid.Health) then
                            repeat
                                wait(_G.Fast_Delay)
                                AttackNoCoolDown()
                                AutoHaki()
                            ...
                            until not (_G.AutoBoss and v475.Parent) or v475.Humanoid.Health <= 0
                        end
                    end
            ...
            pcall(function()
                ...
                if game:GetService('Workspace').Enemies:FindFirstChild(MMon) then
                    ...
                    while true do
                        ...
                        if v482:FindFirstChild('Humanoid') and v482:FindFirstChild('HumanoidRootPart') and (v482.Humanoid.Health > 0 and v482.Name == MMon) then
                            repeat
                                ...
                                MonFarm = v482.Name
                            until not (_G.AutoMaterial and v482.Parent) or v482.Humanoid.Health <= 0
                    ...
                    while true do
                        ...
                        if string.find(v486.Name, Mon) and 10 <= (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v486.Position).Magnitude then
...
if Sea3 then
    u3.Sea:AddSection('Kitsune Island')
    ...
    function UpdateKitsune()
        if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
            u487:SetDesc('Kitsune Island : \u{2705}\u{fe0f}')
        else
            u487:SetDesc('Kitsune Island : \u{274c}\u{fe0f}')
        end
    end
    ...
    v555('Auto Find Prehistoric', 'AutoFindPrehistoric', v520.Prehistoric, 'PrehistoricIsland', 'Prehistoric Island Has Been Found')
    v555('Auto Find Mirage', 'AutoFindMirage', v520.Mirage, 'MysticIsland', 'Mirage Island Has Been Found')
    v555('Auto Find Frozen', 'AutoFindFrozen', v520.Frozen, 'FrozenDimension', 'Frozen Dimension Has Been Found')
    u3.Sea:AddToggle('AutoComeTiki', {
        Title = 'Auto Come Tiki',
        Description = '',
        Default = false,
    ...
    u3.Sea:AddButton({
        ...
        Description = 'The Only Boat You Buy Where You Choose',
        Callback = function()
            u596()
        end,
    })
            ...
            if _G.AutoTerrorshark then
                pcall(function()
                    ...
                    if _Character5 and _Character5:FindFirstChild('Humanoid') then
                        ...
                        if _G.IsFlying and 8000 <= _Character5.Humanoid.Health then
                            _G.IsFlying = false
                        end
                        if not _G.IsFlying and 8000 <= _Character5.Humanoid.Health then
                            if game:GetService('Workspace').Enemies:FindFirstChild('Terrorshark') then
                                ...
                                while true do
                                    ...
                                    if v606.Name == 'Terrorshark' and v606:FindFirstChild('Humanoid') and (v606:FindFirstChild('HumanoidRootPart') and 0 < v606.Humanoid.Health) then
                                        while true do
                                            wait(_G.Fast_Delay)
                                            ...
                                            if not (_G.AutoTerrorshark and v606.Parent) or (v606.Humanoid.Health <= 0 or _G.IsFlying) then
                                                break
                                            end
                                        end
                                    end
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Piranha') then
                        ...
                        while true do
                            ...
                            if v611.Name == 'Piranha' and v611:FindFirstChild('Humanoid') and (v611:FindFirstChild('HumanoidRootPart') and 0 < v611.Humanoid.Health) then
                                repeat
                                    wait(_G.Fast_Delay)
                                    AttackNoCoolDown()
                                    AutoHaki()
                                ...
                                until not (_G.farmpiranya and v611.Parent) or v611.Humanoid.Health <= 0
                            end
                        end
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Shark') then
                        ...
                        while true do
                            ...
                            if v616.Name == 'Shark' and v616:FindFirstChild('Humanoid') and (v616:FindFirstChild('HumanoidRootPart') and 0 < v616.Humanoid.Health) then
                                repeat
                                    wait(_G.Fast_Delay)
                                    AttackNoCoolDown()
                                    AutoHaki()
                                ...
                                until not (_G.AutoShark and v616.Parent) or v616.Humanoid.Health <= 0
                            end
                        end
                    else
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Fish Crew Member') then
                        ...
                        while true do
                            ...
                            if v621.Name == 'Fish Crew Member' and v621:FindFirstChild('Humanoid') and (v621:FindFirstChild('HumanoidRootPart') and 0 < v621.Humanoid.Health) then
                                repeat
                                    wait(_G.Fast_Delay)
                                    AttackNoCoolDown()
                                    AutoHaki()
                                    ...
                                    game.Players.LocalPlayer.Character.Humanoid.Sit = false
                                until not (_G.AutoFishCrew and v621.Parent) or v621.Humanoid.Health <= 0
                            end
                        end
                    else
                        Tween(game:GetService('Workspace').Boats.PirateGrandBrigade.VehicleSeat.CFrame * CFrame.new(0, 1, 0))
...
if Sea3 then
    u3.Sea:AddSection('Mirage Island')
    ...
    spawn(function()
        pcall(function()
            while wait() do
                u658:SetDesc('Mirage: ' .. MirageStatus .. ' | Full Moon: ' .. FullMoonStatus)
            end
        end)
    end)
    u3.Sea:AddButton({
...
spawn(function()
    while task.wait() do
        if _G.Auto_Saber and 200 <= game.Players.LocalPlayer.Data.Level.Value then
            pcall(function()
                                ...
                                elseif game:GetService('Workspace').Enemies:FindFirstChild('Mob Leader') or game:GetService('ReplicatedStorage'):FindFirstChild('Mob Leader') then
                                    ...
                                    while true do
                                        ...
                                        if v684.Name == 'Mob Leader' then
                                            if game:GetService('Workspace').Enemies:FindFirstChild('Mob Leader [Lv. 120] [Boss]') and v684:FindFirstChild('Humanoid') and (v684:FindFirstChild('HumanoidRootPart') and 0 < v684.Humanoid.Health) then
                                                repeat
                                                    task.wait(_G.Fast_Delay)
                                                    AutoHaki()
                                                    EquipTool(SelectWeapon)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Thunder God') then
                    ...
                    while true do
                        ...
                        if v690.Name == 'Thunder God' and v690:FindFirstChild('Humanoid') and (v690:FindFirstChild('HumanoidRootPart') and 0 < v690.Humanoid.Health) then
                            repeat
                                task.wait(_G.Fast_Delay)
                                AutoHaki()
                                EquipTool(SelectWeapon)
                                ...
                                AttackNoCoolDown()
                            until not (_G.Auto_PoleV1 and v690.Parent) or v690.Humanoid.Health <= 0
                        end
                    end
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('The Saw') then
                    ...
                    while true do
                        ...
                        if v696.Name == 'The Saw' and v696:FindFirstChild('Humanoid') and (v696:FindFirstChild('HumanoidRootPart') and 0 < v696.Humanoid.Health) then
                            repeat
                                task.wait(_G.Fast_Delay)
                                AutoHaki()
                                EquipTool(SelectWeapon)
                                ...
                                AttackNoCoolDown()
                            until not (_G.Auto_Saw and v696.Parent) or v696.Humanoid.Health <= 0
                        end
                    end
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Chief Warden') then
                    ...
                    while true do
                        ...
                        if v702.Name == 'Chief Warden' and v702:FindFirstChild('Humanoid') and (v702:FindFirstChild('HumanoidRootPart') and 0 < v702.Humanoid.Health) then
                            repeat
                                task.wait(_G.Fast_Delay)
                                AutoHaki()
                                EquipTool(SelectWeapon)
                                ...
                                AttackNoCoolDown()
                            until not (_G.Auto_Warden and v702.Parent) or v702.Humanoid.Health <= 0
                        end
                    end
...
if Sea3 then
    ...
    spawn(function()
        ...
        if v713.Name == ('Longma' or v713.Name == 'Longma') and 0 < v713.Humanoid.Health and (v713:IsA('Model') and v713:FindFirstChild('Humanoid')) and v713:FindFirstChild('HumanoidRootPart') then
        else
        end
    end)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Beautiful Pirate') then
                    ...
                    while true do
                        ...
                        if v720.Name == 'Beautiful Pirate' and v720:FindFirstChild('Humanoid') and (v720:FindFirstChild('HumanoidRootPart') and 0 < v720.Humanoid.Health) then
                            repeat
                                task.wait(_G.Fast_Delay)
                                AutoHaki()
                                EquipTool(SelectWeapon)
                                ...
                                AttackNoCoolDown()
                            until not (_G.Auto_Canvander and v720.Parent) or v720.Humanoid.Health <= 0
                        end
                    end
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Cake Queen') then
                    ...
                    while true do
                        ...
                        if v766.Name == 'Cake Queen' and v766:FindFirstChild('Humanoid') and (v766:FindFirstChild('HumanoidRootPart') and 0 < v766.Humanoid.Health) then
                            repeat
                                task.wait(_G.Fast_Delay)
                                AutoHaki()
                                EquipTool(SelectWeapon)
                                ...
                                AttackNoCoolDown()
                            until not (_G.Auto_Buddy and v766.Parent) or v766.Humanoid.Health <= 0
                        end
                    end
    ...
    while wait() do
        if Auto_Quest_Yama_3 then
            pcall(function()
                    ...
                    if game:GetService('Workspace').Enemies:FindFirstChild('Soul Reaper') or game.ReplicatedStorage:FindFirstChild('Soul Reaper [Lv. 2100] [Raid Boss]') then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Soul Reaper') then
                            ...
                            while true do
                                ...
                                if v800.Name == 'Soul Reaper' and 0 < v800.Humanoid.Health then
                                    repeat
                                        wait()
                ...
                wait()
                EquipTool(Sword)
                Tween(v802.HumanoidRootPart.CFrame * Pos)

                v802.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                v802.HumanoidRootPart.Transparency = 1
                v802.Humanoid.JumpPower = 0
                v802.Humanoid.WalkSpeed = 0
                v802.HumanoidRootPart.CanCollide = false
                FarmPos = v802.HumanoidRootPart.CFrame
                MonFarm = v802.Name

                AttackNoCoolDown()

                if v802.Humanoid.Health <= 0 and v802.Humanoid:FindFirstChild('Animator') then
                    v802.Humanoid.Animator:Destroy()
                end
                if v802.Humanoid.Health > 0 and v802.Parent and Auto_Quest_Yama_3 ~= false then
                end

                local v801, v802 = v803(v804, v801)

                if v801 == nil then
                end
                if (v802.Name == 'Cursed Skeleton' or v802.Name == 'Cursed Skeleton' or v802.Name == "Hell's Messenger") and v802.Humanoid.Health > 0 then
                else
                end
                ...
                v803, v804, v801 = pairs(game:GetService('Workspace').Enemies:GetChildren())
            end)
        end
    end
end)
    ...
    while wait() do
        if Auto_Quest_Tushita_2 then
            pcall(function()
                ...
                if not (Auto_Quest_Tushita_2 and v808:FindFirstChild('HumanoidRootPart')) or (not v808:FindFirstChild('Humanoid') or 0 >= v808.Humanoid.Health) or (v808.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 2000 then
                end
                ...
                if v808.Humanoid.Health <= 0 or not v808.Parent or Auto_Quest_Tushita_2 == false then
                else
                end
            end)
        end
        ...
        if Auto_Quest_Tushita_3 then
            pcall(function()
                ...
                while true do
                    ...
                    if v812.Name == 'Cake Queen' and 0 < v812.Humanoid.Health then
                        repeat
                            wait()
                            EquipTool(Sword)
                ...
                local v813, v814, v815 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                local v816
                ...
                if v816.Name ~= 'Cursed Skeleton' and v816.Name ~= 'Cursed Skeleton' and v816.Name ~= "Heaven's Guardian" or v816.Humanoid.Health <= 0 then
                end

                wait()
                EquipTool(Sword)
                Tween(v816.HumanoidRootPart.CFrame * Pos)

                v816.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                v816.HumanoidRootPart.Transparency = 1
                v816.Humanoid.JumpPower = 0
                v816.Humanoid.WalkSpeed = 0
                v816.HumanoidRootPart.CanCollide = false
                FarmPos = v816.HumanoidRootPart.CFrame
                MonFarm = v816.Name

                AttackNoCoolDown()

                if v816.Humanoid.Health <= 0 and v816.Humanoid:FindFirstChild('Animator') then
                    v816.Humanoid.Animator:Destroy()
                end
                if v816.Humanoid.Health <= 0 or not v816.Parent or Auto_Quest_Tushita_3 == false then
                else
                end
                if not (_G.Auto_DualKatana and Auto_Quest_Tushita_3) or GetMaterial('Alucard Fragment') == 6 then
                end
                if true then
                else
                end
...
if Sea2 then
    ...
    spawn(function()
        ...
        if v821.Name ~= 'Core' or 0 >= v821.Humanoid.Health then
        end
            ...
            if _G.AutoFarmSwan then
                if game:GetService('Workspace').Enemies:FindFirstChild('Don Swan') then
                    ...
                    while true do
                        ...
                        if u826.Name == 'Don Swan' and 0 < u826.Humanoid.Health and (u826:IsA('Model') and u826:FindFirstChild('Humanoid')) and u826:FindFirstChild('HumanoidRootPart') then
                            repeat
                                task.wait()
                                pcall(function()
                                    AutoHaki()
...
u3.Setting:AddSection('Skill Mastery')
...
local function u884()
    ...
    u879:SetDesc(string.format('%02d Hour-%02d Minute-%02d Second', v881, v882, v883))
end
...
local _ThGii = u3.Teleport:AddSection('Tp Sea')

u3.Teleport:AddToggle('ToggleAutoSea2', {
    Title = 'Quest To Sea 2',
    Description = '',
    Default = false,
            ...
            pcall(function()
                if game:GetService('Players').LocalPlayer.Data.Level.Value >= 700 and World1 then
                    if game:GetService('Workspace').Map.Ice.Door.CanCollide ~= false or game:GetService('Workspace').Map.Ice.Door.Transparency ~= 1 then
                        if game:GetService('Workspace').Map.Ice.Door.CanCollide == false and game:GetService('Workspace').Map.Ice.Door.Transparency == 1 then
                            if game:GetService('Workspace').Enemies:FindFirstChild('Ice Admiral') then
                                ...
                                while true do
                                    ...
                                    if v921.Name == 'Ice Admiral' then
                                        if not v921.Humanoid.Health > 0 then
                                            game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('TravelDressrosa')
                                        elseif v921:FindFirstChild('Humanoid') and v921:FindFirstChild('HumanoidRootPart') and v921.Humanoid.Health > 0 then
                                            OldCFrameSecond = v921.HumanoidRootPart.CFrame
                                            ...
                                            repeat
                                                ...
                                                v921.Humanoid.WalkSpeed = 0
                                                v921.Head.CanCollide = false
                                                v921.HumanoidRootPart.Size = Vector3.new(50, 50, 50)
                                                v921.HumanoidRootPart.CFrame = OldCFrameSecond

                                                Tween(v921.HumanoidRootPart.CFrame * Pos)
                                                AttackNoCoolDown()
                                                sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                                            until not _G.Auto_Sea2 or (not v921.Parent or v921.Humanoid.Health <= 0)
                                        end
                                    end
                                end
                        ...
                        local v922 = CFrame.new(4849.29883, 5.65138149, 719.611877)

                        repeat
                            Tween(v922)
                            wait()
                        until (v922.Position - game:GetService('Players').LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or _G.Auto_Sea2 == false
...
u3.Teleport:AddSection('Tp Island')
...
spawn(function()
    pcall(function()
        while wait() do
            if Auto_Law and not game:GetService('Players').LocalPlayer.Character:FindFirstChild('Microchip') and not (game:GetService('Players').LocalPlayer.Backpack:FindFirstChild('Microchip') or game:GetService('Workspace').Enemies:FindFirstChild('Order')) and not game:GetService('ReplicatedStorage'):FindFirstChild('Order') then
                wait()
...
spawn(function()
    pcall(function()
        while wait() do
            if Auto_Law then
                if not (game:GetService('Workspace').Enemies:FindFirstChild('Order') or game:GetService('ReplicatedStorage'):FindFirstChild('Order')) and (game:GetService('Players').LocalPlayer.Character:FindFirstChild('Microchip') or game:GetService('Players').LocalPlayer.Backpack:FindFirstChild('Microchip')) then
...
u3.Race:AddSection('Trial features')
u3.Race:AddButton({
    Title = 'Race Door',
    Description = '',
    Callback = function()
                                        ...
                                        if u1025:FindFirstChild('Humanoid') and u1025:FindFirstChild('HumanoidRootPart') and u1025.Humanoid.Health > 0 then
                                            pcall(function()
                                                repeat
                                                    ...
                                                    sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                                until not (_G.AutoQuestRace and u1025.Parent) or u1025.Humanoid.Health <= 0
                                            end)
                                        end
                                    end
                                end
                        ...
                        if u1053:FindFirstChild('Humanoid') and u1053:FindFirstChild('HumanoidRootPart') and u1053.Humanoid.Health > 0 then
                            pcall(function()
                                repeat
                                    ...
                                    sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                until not (_G.AutoQuestRace and u1053.Parent) or u1053.Humanoid.Health <= 0
                            end)
                        end
                    end
                end
...
u3.Race:AddToggle('ToggleKillTrial', {
    Title = 'Auto Kill Player In Trial',
    Description = '',
    Default = false,
        ...
        pcall(function()
            if _G.AutoKillTrial then
                ...
                while true do
                    ...
                    if v1058.Name and v1058.Name ~= game.Players.LocalPlayer.Name and ((v1058.Character.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 100 and 0 < v1058.Character.Humanoid.Health) then
                        repeat
                            wait(_G.Fast_Delay)
                            EquipTool(SelectWeapon)
                            AutoHaki()
                            ...
                            AttackNoCoolDown()
                        until not (_G.AutoKillTrial and v1058.Parent) or v1058.Character.Humanoid.Health <= 0
                    end
                end
            end
        end)
...
u3.Shop:AddSection('Change race...')
u3.Shop:AddButton({
    Title = 'Change Stats',
    Description = '',
    Callback = function()
...
u3.Shop:AddButton({
    Title = 'Trade Draco Race',
    Description = 'Only In Sea 3',
    Callback = function()
        game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('requestEntrance', Vector3.new(5661.5322265625, 1013.0907592773438, -334.9649963378906))
...
u3.Misc:AddSection('Redeem codes (it may not redeem nothing)')
        ...
        pcall(function()
            while wait() do
                ...
                elseif _InfoLeviathan == 0 then
                    ...
                    u1102:SetDesc('Buy: ' .. tostring(_InfoLeviathan))
                end
            end
        end)
    end)
...
u3.Sea:AddToggle('ToggleBlazeEmberFarm', {
    Title = 'Auto Hydra Enforcer + Venomous Assailant',
    Description = '',
    Default = false,
        ...
        spawn(function()
            pcall(function()
                while wait() do
                    ...
                    game:GetService('ReplicatedStorage').Modules.Net:FindFirstChild('RF/DragonHunter'):InvokeServer(unpack(v1112))
                    ...
                    game:GetService('ReplicatedStorage').Modules.Net:FindFirstChild('RF/DragonHunter'):InvokeServer(unpack(v1113))
                end
            end)
        end)
    end
...
local u1114 = u3.Sea:AddParagraph({
...
spawn(function()
    pcall(function()
        while wait() do
            ...
            local v1116 = game:GetService('ReplicatedStorage').Modules.Net:FindFirstChild('RF/DragonHunter'):InvokeServer(unpack(v1115))

            if typeof(v1116) == 'table' then
                local v1117, v1118, v1119 = pairs(v1116)
                ...
                while true do
                    ...
                    if v1120 == 'Defeat 3 Venomous Assailants on Hydra Island.' then
                        u1114:SetDesc('Defeat 3 Venomous Assailants on Hydra Island.')
                    elseif v1120 == 'Defeat 3 Hydra Enforcers on Hydra Island.' then
                        u1114:SetDesc('Defeat 3 Hydra Enforcers on Hydra Island.')
                    elseif v1120 == 'Destroy 10 trees on Hydra Island.' then
                        u1114:SetDesc('Destroy 10 trees on Hydra Island.')
                    end
                end
            end
        end
...
u3.Sea:AddToggle('ToggleHydraTree', {
    ...
    _G.AutoHydraTree = p1121
end)

local function u1124(p1122)
    local _VirtualInputManager2 = game:GetService('VirtualInputManager')

    _VirtualInputManager2:SendKeyEvent(true, p1122, false, game)
    _VirtualInputManager2:SendKeyEvent(false, p1122, false, game)
end
local function u1136(p1125)
    local _LocalPlayer8 = game.Players.LocalPlayer
    local _Backpack = _LocalPlayer8.Backpack
    local v1128, v1129, v1130 = pairs(_Backpack:GetChildren())
    ...
    while true do
        ...
        if v1131:IsA('Tool') and v1131.ToolTip == p1125 then
            v1131.Parent = _LocalPlayer8.Character

            local v1132, v1133, v1134 = ipairs({
                'Z',
                'X',
                'C',
                'V',
...
spawn(function()
    while wait() do
        if _G.AutoHydraTree then
            ...
            local v1138, v1139, v1140 = ipairs(u1137)
            ...
            while true do
                ...
                if v1140 == nil or not _G.AutoHydraTree then
                    break
                end
                ...
                if _Character8 and _Character8:FindFirstChild('HumanoidRootPart') and (_Character8.HumanoidRootPart.Position - v1141.Position).Magnitude <= 1 then
                    u1136('Melee')
                    u1136('Sword')
                    u1136('Gun')
                end
...
u3.Sea:AddButton({
    ...
    Description = 'Requires 15 Blaze Ember + 10 Scrap Metal',
    Callback = function()
        game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack({
            'CraftItem',
            'Craft',
...
u3.Sea:AddButton({
    ...
    Description = 'Requires 25 Dinosaur Bones + 10 Rhino Horns',
    Callback = function()
        game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack({
            'CraftItem',
            'Craft',
...
u3.Sea:AddButton({
    ...
    Description = 'Requires 8 Dinosaur Bones + 5 Dragon Scales',
    Callback = function()
        game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack({
            'CraftItem',
            'Craft',
...
u3.Sea:AddToggle('ToggleCollectFireFlowers', {
    Title = 'Collect Fire Flower',
    Description = '',
    Default = false,
}):OnChanged(function(p1143)
    _G.AutoCollectFireFlowers = p1143
end)
spawn(function()
    while wait() do
        local v1144 = _G.AutoCollectFireFlowers and workspace:FindFirstChild('FireFlowers')

        if v1144 then
            local v1145, v1146, v1147 = pairs(v1144:GetChildren())
            ...
            while true do
                ...
                if v1148:IsA('Model') and v1148.PrimaryPart then
                    local _Position12 = v1148.PrimaryPart.Position
...
u3.Sea:AddToggle('ToggleWhiteBelt', {
    ...
    if p1150 then
        ...
        game:GetService('ReplicatedStorage').Modules.Net:FindFirstChild('RF/InteractDragonQuest'):InvokeServer(unpack(v1151))
        spawn(function()
            while _G.AutoLevel do
                ...
                game:GetService('ReplicatedStorage').Modules.Net:FindFirstChild('RF/InteractDragonQuest'):InvokeServer(unpack(v1152))
                wait()
            end
        end)
    end
...
u3.Sea:AddToggle('ToggleTrialTeleport', {
    Title = 'Fly To Draco Door',
    Description = '',
    Default = false,
}):OnChanged(function(p1153)
    _G.AutoTrialTeleport = p1153
end)
spawn(function()
    while wait() do
...
u3.Sea:AddSection('Prehistoric')

local u1155 = u3.Sea:AddParagraph({
    Title = 'Prehistoric Islandn Status',
    Content = '',
})
    ...
    pcall(function()
        while wait() do
            if game:GetService('Workspace').Map:FindFirstChild('PrehistoricIsland') then
                u1155:SetDesc('Prehistoric: \u{2705}\u{fe0f}')
            else
                u1155:SetDesc('Prehistoric: \u{274c}\u{fe0f}')
            end
        end
    end)
end)
u3.Sea:AddToggle('ToggleTPVolcano', {
    Title = 'Fly To Prehistoric',
    Description = '',
    Default = false,
}):OnChanged(function(p1156)
    _G.TweenToPrehistoric = p1156
end)
...
spawn(function()
    ...
    while not v1157 do
        v1157 = game:GetService('Workspace').Map:FindFirstChild('PrehistoricIsland')

        wait()
    end
    while wait() do
        local v1158 = _G.TweenToPrehistoric and game:GetService('Workspace').Map:FindFirstChild('PrehistoricIsland')

        if v1158 then
            local _Core = v1158:FindFirstChild('Core')

            if _Core then
                _Core = v1158.Core:FindFirstChild('PrehistoricRelic')
            end
            if _Core then
...
u3.Sea:AddToggle('ToggleDefendVolcano', {
    ...
    Description = '',
    Default = false,
}):OnChanged(function(p1160)
    _G.AutoDefendVolcano = p1160
end)
...
u3.Sea:AddToggle('ToggleGun', {
    ...
    Description = '',
    Default = false,
}):OnChanged(function(p1163)
    _G.UseGun = p1163
end)

local function u1165(p1164)
    game:GetService('VirtualInputManager'):SendKeyEvent(true, p1164, false, game)
    game:GetService('VirtualInputManager'):SendKeyEvent(false, p1164, false, game)
end
local function u1181()
    ...
    if _PrehistoricIsland then
        local v1168, v1169, v1170 = pairs(_PrehistoricIsland:GetDescendants())
        ...
        while true do
            ...
            if v1171:IsA('Part') and v1171.Name:lower():find('lava') then
                v1171:Destroy()
            end
        end
    end
    ...
    if _PrehistoricIsland2 then
        local v1173, v1174, v1175 = pairs(_PrehistoricIsland2:GetDescendants())
        ...
        while true do
            ...
            if v1176:IsA('Model') then
                ...
                while true do
                    ...
                    if v1180:IsA('MeshPart') and v1180.Name:lower():find('lava') then
                        v1180:Destroy()
                    end
                end
            end
...
local function u1189()
    local _VolcanoRocks = game.Workspace.Map.PrehistoricIsland.Core.VolcanoRocks
    local v1183, v1184, v1185 = pairs(_VolcanoRocks:GetChildren())
    ...
    while true do
        ...
        if v1186:IsA('Model') then
            local _volcanorock = v1186:FindFirstChild('volcanorock')
...
local function u1201(p1190)
    ...
    while true do
        ...
        if v1196:IsA('Tool') and v1196.ToolTip == p1190 then
            v1196.Parent = _LocalPlayer9.Character

            local v1197, v1198, v1199 = ipairs({
                'Z',
                'X',
                'C',
                'V',
...
spawn(function()
    while wait() do
        if _G.AutoDefendVolcano then
            ...
            if v1202 then
                local v1203 = CFrame.new(v1202.Position + Vector3.new(0, 0, 0))

                Tween2(v1203)

                local _Color2 = v1202.Color

                if _Color2 == Color3.fromRGB(185, 53, 56) or _Color2 == Color3.fromRGB(185, 53, 57) then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v1202.Position - Vector3.new(0, 0, 0)).Magnitude <= 1 then
                        if _G.UseMelee then
                            u1201('Melee')
                        end
                        if _G.UseSword then
...
spawn(function()
    while wait() do
        if KillAura then
            pcall(function()
                local v1206, v1207, v1208 = pairs(game.Workspace.Enemies:GetDescendants())
                ...
                while true do
                    ...
                    if v1209:FindFirstChild('Humanoid') and v1209:FindFirstChild('HumanoidRootPart') and v1209.Humanoid.Health > 0 then
                        repeat
                            task.wait()
                            sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)

                            v1209.Humanoid.Health = 0
                            v1209.HumanoidRootPart.CanCollide = false
                        until not (KillAura and v1209.Parent) or v1209.Humanoid.Health <= 0
                    end
                end
            end)
        end
...
u3.Sea:AddToggle('ToggleCollectBone', {
    ...
    _G.AutoCollectBone = p1210
end)
spawn(function()
    while wait() do
        if _G.AutoCollectBone then
            local v1211, v1212, v1213 = pairs(workspace:GetDescendants())
            ...
            while true do
                ...
                if v1214:IsA('BasePart') and v1214.Name == 'DinoBone' then
                    Tween2(CFrame.new(v1214.Position))
                end
            end
        end
    end
...
u3.Sea:AddToggle('ToggleCollectEgg', {
    ...
    Description = '',
    Default = false,
}):OnChanged(function(p1215)
    _G.AutoCollectEgg = p1215
end)
spawn(function()
    while wait() do
        if _G.AutoCollectEgg then
            local v1216 = workspace.Map.PrehistoricIsland.Core.SpawnedDragonEggs:GetChildren()

            if #v1216 > 0 then
                local v1217 = v1216[math.random(1, #v1216)]

                if v1217:IsA('Model') and v1217.PrimaryPart then
                    Tween2(v1217.PrimaryPart.CFrame)

                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v1217.PrimaryPart.Position).Magnitude <= 1 then
                        game:GetService('VirtualInputManager'):SendKeyEvent(true, 'E', false, game)
                        wait(1.5)
                        game:GetService('VirtualInputManager'):SendKeyEvent(false, 'E', false, game)
                    end
